    ...
    function Recorder(source, cfg) {
        ...
        this.worker = new _inlineWorker2.default(function () {
            ...
            function exportWAV(type) {
                var buffers = [];
                for (var channel = 0; channel < numChannels; channel++) {
                    var merged_b = mergeBuffers(recBuffers[channel], recLength)
                    var downsampled_b = downsampleBuffer(merged_b, sampleRate, targetSampleRate)
                    buffers.push(downsampled_b);
                }
                ...
                var dataview = encodeWAV(interleaved, targetSampleRate, numChannels);
            ...
            function encodeWAV(samples, _sampleRate, _numChannels) {
